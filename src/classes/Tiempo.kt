...
class Tiempo(var hora: Int, var min: Int, var seg: Int) {
    ...
    fun incrementar(t: Tiempo): Boolean {
        return if (obtenerSegundos() + t.obtenerSegundos() > MAX_SEGUNDOS) {
            false
        } else {
...
//
     ...
     */
    fun esMayorQue(t: Tiempo): Boolean = this.comparar(t) == 1
     ...
     */
    fun esMenorQue(t: Tiempo): Boolean = this.comparar(t) == -1
